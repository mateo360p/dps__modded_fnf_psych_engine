...
class Note extends FlxSprite
{
	...
	public static var noteTypeRgbShaders:Array<RGBPalette> = [];
	...
	**/
	...
	function loadNoteAnims() {
		...
		if (isSustainNote)
		{
			atrgbArraytToAddAnimationByPrefix('purpleholdend', 'pruple end hold', 24, true); // this fixes some retarded typo from the original note .FLA
	...
	function atrgbArraytToAddAnimationByPrefix(name:String, prefix:String, framerate:Float = 24, doLoop:Bool = true)
	{
		var animFrames = [];
		@:privateAccess
