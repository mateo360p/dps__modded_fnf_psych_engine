...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		rating = new FlxSprite().loadGraphic(Paths.image('UI/' + ClientPrefs.data.uiSet + '/rating/sick'));
		...
		{
			var numScore:FlxSprite = new FlxSprite(43 * daLoop).loadGraphic(Paths.image('UI/' + ClientPrefs.data.uiSet + '/num/num' + i));
