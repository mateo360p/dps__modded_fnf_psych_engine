...
{
	public static var ModdedEngineVersion:String = '0.0.2.3'; // Lol like 8 updates without updating this 
	...
	override function create()
	{
		...
		if (leftOption != null)
			leftItem = createMenuItem(leftOption, 60, 350);
		if (rightOption != null)
		{
			rightItem = createMenuItem(rightOption, FlxG.width - 60, 350);
